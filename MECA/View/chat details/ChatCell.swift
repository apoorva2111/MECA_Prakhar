...
class ChatCell: LKBaseCollectionViewCell {
    ...
    static let grayBubbleImage = UIImage(named: "grey_box")!.resizableImage(withCapInsets: UIEdgeInsets(top: 22, left: 26, bottom: 22, right: 26)).withRenderingMode(.alwaysTemplate)
    static let blueBubbleImage = UIImage(named: "blue_box")!.resizableImage(withCapInsets: UIEdgeInsets(top: 22, left: 26, bottom: 22, right: 26)).withRenderingMode(.alwaysTemplate)
    ...
    var profileImageView: UIImageView = {
        ...
        imageView.image = #imageLiteral(resourceName: "Blue_comment")
